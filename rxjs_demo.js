...
import { of ,fromEvent ,interval ,from  ,bindCallback} from 'rxjs'; 
...
import { map ,pluck , filter ,tap ,concatMap ,take , switchMap} from 'rxjs/operators';
...
import { of ,fromEvent , from ,interval ,concat } from 'rxjs'; 
import { map ,pluck , filter ,tap ,concatMap ,take , switchMap,
...
/////////////////////////////////
import {from ,  of ,fromEvent ,bindCallback  } from 'rxjs'; 
